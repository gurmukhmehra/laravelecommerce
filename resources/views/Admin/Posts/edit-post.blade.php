            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Edit Post ; {{$postDetail->title}}</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body table-border-style">
                ...
                {{ Form::open(array('url' => 'admin/post/edit/'.$postDetail->postSlug, 'enctype' =>'multipart/form-data')) }}
                    <input type="hidden" name="id" value="{{ $postDetail->id }}" class="form-control" id="">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="" class="font-weight-bold">Post Title <sup class="text-danger" style="font-size:15px;">*</sup></label>
                            <input type="text" name="title" value="{{ $postDetail->title }}" required class="form-control" id="" placeholder="Product Name">
                        </div>                        
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                    ...
                    <div class="form-row mt-3">
                        ...
                        <textarea class="form-control ckeditor" required id="" name="description" placeholder="Description">{{ $postDetail->description }}</textarea>                        
                    </div>
                    <div class="form-row mt-3">
                        <div class="form-group col-md-6">
                            ...
                            @if(!empty($postDetail->postImage))                                        
                                <img src="{{ URL::asset('uploads/posts_images/'.$postDetail->postImage) }}" style="width: 50%;border-radius: 13px;" />
                            @else 
                        ...
                        <div class="form-group col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" name="postStatus" id="inputGroupSelect01">
                                    <option value="publish" @if($postDetail->postStatus=='publish') selected @endif>Publish</option>
                                    <option value="draft" @if($postDetail->postStatus=='draft') selected @endif>Draft</option>
                                </select>
                            </div>                            
                        </div>                       
                    </div>
